        ...
        const config : any = {
            ...
            statistic: {
                title: {
                    ...
                    formatter: () => (0.004627/2*100).toFixed(2)+"%"
                },
                content: {
                style: {
                    fontSize: "20px",
        ...
        const config : any = {
            ...
            statistic: {
                title: {
                    ...
                    formatter: () => (0.002711/2*100).toFixed(2)+"%"
                },
                content: {
                style: {
                    fontSize: "20px",
                        ...
                        <div className={styles.priceInfo_box}>
                            ...
                            <div style={{"padding":"20px"}}>
                                ...
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>거더하면</Col>
                                    <Col span={10}>687장</Col>
                                    <Col span={10}>274,800 원</Col>
                                </Row>
                                <Row className={styles.priceInfo_text}>
                                    <Col span={4}>거더측면</Col>
                                    <Col span={10}>29장</Col>
                                    <Col span={10}>11,600원</Col>
                                </Row>
                                <Row className={styles.priceInfo_text}>
                                    <Col span={4} >슬라브 하면</Col>
                                    <Col span={10}>66장 </Col>
                                    <Col span={10}>26,400원</Col>
                                </Row>
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>교각</Col>
                                    <Col span={10}>123장</Col>
                                    <Col span={10}>49,200원</Col>
                                </Row>
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>총 요금</Col>
                                ...
                                <Row className={styles.priceInfo_text_title}>
                                    <Col span={24} style={{"textAlign":"center", "backgroundColor":"aqua" }}>베이직 요금제 : 1,362,000원</Col>
                                    {/* <Col span={2}>/</Col>
                            ...
                            <div style={{"padding":"20px"}}>
                                ...
                                <Row className={styles.priceInfo_text_title}>
                                    <Col span={24}  style={{"textAlign":"center", "backgroundColor":"aqua"}}>베이직 요금제 : 1,012,000원</Col>
                                    {/* <Col span={2}>/</Col>
                            ...
                            <div style={{"padding":"20px"}}>
                                ...
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>거더하면</Col>
                                    <Col span={10}>3,348MB x 20원</Col>
                                    <Col span={10}>66,960원</Col>
                                </Row>
                                <Row className={styles.priceInfo_text}>
                                    <Col span={4}>거더측면</Col>
                                    <Col span={10}>242MB x 20원 </Col>
                                    <Col span={10}>4,840원</Col>
                                </Row>
                                <Row className={styles.priceInfo_text}>
                                    <Col span={4} >슬라브 하면</Col>
                                    <Col span={10}>248MB x 20원 </Col>
                                    <Col span={10}>4,960원</Col>
                                </Row>
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>교각</Col>
                                    <Col span={10}>1,013MB x 20원</Col>
                                    <Col span={10}>20,260원</Col>
                                </Row>
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>총 요금</Col>
                                ...
                                <Row className={styles.priceInfo_text_title}>
                                    <Col span={11}>베이직 : 1,097,020원</Col>
                                    <Col span={2}>/</Col>
                                    <Col span={11}>프리미엄 : 2,097,020원</Col>
                                </Row>
                            </div>
                            <Row>
                                <Col className={styles.priceInfo_text_title}>
                            ...
                            <div style={{"padding":"20px"}}>
                                ...
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>거더하면</Col>
                                    <Col span={10}>1,443MB x 20원</Col>
                                    <Col span={10}>28,860원</Col>
                                </Row>
                                <Row className={styles.priceInfo_text}>
                                    <Col span={4}>거더측면</Col>
                                    <Col span={10}>244MB x 20원 </Col>
                                    <Col span={10}>4,880원</Col>
                                </Row>
                                <Row className={styles.priceInfo_text}>
                                    <Col span={4} >슬라브 하면</Col>
                                    <Col span={10}>320MB x 20원 </Col>
                                    <Col span={10}>6,400원</Col>
                                </Row>
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>교각</Col>
                                    <Col span={10}>835MB x 20원</Col>
                                    <Col span={10}>16,700원</Col>
                                </Row>
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>총 요금</Col>
                                ...
                                <Row className={styles.priceInfo_text_title} >
                                    <Col span={11}>베이직 : 1,056,840원</Col>
                                    <Col span={2}>/</Col>
                                    <Col span={11}>프리미엄 : 2,056,840원</Col>
                                </Row>
                            </div>
                        </div> 
                </div>   

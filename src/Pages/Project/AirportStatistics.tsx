        ...
        const config : any = {
            ...
            statistic: {
                title: {
                    ...
                    formatter: () => (0.000947/2*100).toFixed(2)+"%"
                },
                content: {
                style: {
                    fontSize: "20px",
        ...
        const config : any = {
            ...
            statistic: {
                title: {
                    ...
                    formatter: () => (0.000051/2*100).toFixed(2)+"%"
                },
                content: {
                style: {
                    fontSize: "20px",
                        ...
                        <div className={styles.priceInfo_box}>
                            ...
                            <div style={{"padding":"20px"}}>
                                ...
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>활주로</Col>
                                    <Col span={10}>120장</Col>
                                    <Col span={10}>48,000 원</Col>
                                </Row>
                                ...
                                <Row className={styles.priceInfo_text_title}>
                                    <Col span={24} style={{"textAlign":"center", "backgroundColor":"aqua" }}>베이직 요금제 : 1,048,000원</Col>
                                    {/* <Col span={2}>/</Col>
                            ...
                            <div style={{"padding":"20px"}}>
                                ...
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>활주로</Col>
                                    <Col span={10}>993MB x 20원</Col>
                                    <Col span={10}>19,860원</Col>
                                </Row>
                                ...
                                <Row className={styles.priceInfo_text_title}>
                                    <Col span={11}>베이직 : 1,019,860원</Col>
                                    <Col span={2}>/</Col>
                                    <Col span={11}>프리미엄 : 2,019,860원</Col>
                                </Row>
                            </div>
                            <Row>
                                <Col className={styles.priceInfo_text_title}>
                            ...
                            <div style={{"padding":"20px"}}>
                                ...
                                <Row  className={styles.priceInfo_text}>
                                    <Col span={4}>활주로</Col>
                                    <Col span={10}>53MB x 20원</Col>
                                    <Col span={10}>1,060원</Col>
                                </Row>
                                ...
                                <Row className={styles.priceInfo_text_title} >
                                    <Col span={11}>베이직 : 1,001,060원</Col>
                                    <Col span={2}>/</Col>
                                    <Col span={11}>프리미엄 : 2,001,060원</Col>
                                </Row>
                            </div>
                        </div> 
                </div>   

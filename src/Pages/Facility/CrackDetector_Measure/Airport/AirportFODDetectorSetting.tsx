...
export default function AirportFODDetectorSetting() {
    ...
    Measure.push({
        input_folder: "stage6_fod",
        output_folder: "stage6_fod"
    }) 
    ...
    const onChange = (e: RadioChangeEvent) => {
        ...
        axios({
            ...
            if(e.target.value===1){
                setWeightData(
                    <div>
                        <p style={{fontSize:"20px", fontWeight:"bold"}}>활주로 FOD 검출 Weight</p>
                ...
                for(let i = 0; i < settings.spanCount; i++){
                    copyArrDetectorList[i] = { ...copyArrDetectorList[i], choice_weight : "D:/exetest/code/FOD_Defect_Detector/Metadata/012_0129.h5"};
    ...
    const [ModelData, setModelData] = useState<any | undefined>(
        <Radio.Group optionType="button">
            <Radio value={1} onChange={onChange}>활주로 FOD 검출</Radio>
            <Radio value={2} onChange={onChange} disabled>??? 활주로 FOD 검출</Radio>
        </Radio.Group>
    ); 
        ...
        const response = axios({
            ...
            for(let i = 1; i < settings.spanCount + 1; i++){
                DetectorList.push({
                    ...
                    output_folder : "stage6_fod",
                    choice_weight : "D:/exetest/code/FOD_Defect_Detector/Metadata/012_0129.h5"
                })
            }
    ...
    <div style={{ width: "50em", margin: "0 auto" }}>
        <br/>        
        <p style={{fontSize:"25px"}}>{t.dmFODDetector}</p>
        <br/>
        <Form labelCol={{ span: 0, }} wrapperCol={{ span: 10, }} layout="horizontal">
            <Form.Item label={t.cnChoiceModel}>
                ...
                <Select.Option value="1">FOD Detector TF1.x</Select.Option>
                    <Select.Option value="2" disabled>FOD Detector TF2.x</Select.Option>
                </Select>
            </Form.Item>
        </Form>
        <div>

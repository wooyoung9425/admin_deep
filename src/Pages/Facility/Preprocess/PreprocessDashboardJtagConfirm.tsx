...
function PreprocessDashboardJtagConfirm() {
    ...
    const response1 = axios({
        ...
        const list  = ["span_move", "joint_edit","joint_copy"];
        if (res.data.check === true) {
            for (let i = 0; i < res.data.data.jobs.length; i++) {
                console.log(res.data.data.jobs[i].task_name, "  ", i)
...
export default PreprocessDashboardJtagConfirm;

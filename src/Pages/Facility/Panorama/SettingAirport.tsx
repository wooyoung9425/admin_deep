...
export default function SettingAirport() {
        ...
        for(let i = 1; i <cameraNo+1; i++)
            ...
            axios({                
                ...
                data: {
                    ...
                    tasks: [
                        {
                            input_folder: `stage2/${projectName}/C0${i}/S00${k}`,
                            output_folder: "stage3",
                            yml_output_folder: "stage3_YML",
                        }
                    ]
                }
            }).then((res)=>{

...
function PanoramaDashboardImageConfirm() {
    ...
    if (project_Type === 'Tunnel') {
        ...
        task_name=['imageresize_airport','horpanorama_airport', 'imageRotation_airport']
    }
...
export default PanoramaDashboardImageConfirm;

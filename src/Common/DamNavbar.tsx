        ...
        const items: MenuItem[] = [
            ...
            getItem(
                ...
                [
                    ...
                    getItem(
                        <Link to="/Facility/PreProcess/SpanFolderDam">
                            <a style={{ textDecoration: "none", color:"black" }}>
                                {t.ppDistFolder}
                            </a>
                        </Link>
            ...
            , 'sub2', [
                getItem(
                <Link to="/Facility/Panorama/SettingDam">
                    <a style={{ textDecoration: "none", color:"black" }}>
                        {t.pnSetting}
                    </a>
                    </Link>
                , '6'),
                getItem(
                    <Link to="/Facility/Panorama/PanoramaHorDam">
                        <a style={{ textDecoration: "none", color:"black" }}>
                ...
                , '8'),
                getItem(
                <Link to="/Facility/Panorama/PanoramaVerDam">
                    <a style={{ textDecoration: "none", color:"black" }}>
            ...
            , 'sub3', [
                getItem(
                    ...
                    , '10'),
                getItem(
                    <Link to="/Facility/CrackDetector_Measure/DamDefectDetector">
                        <a style={{ textDecoration: "none", color:"black" }}>
            ...
            <Link to="/Facility/XAI/DashBoard">
                ...
                , 'sub5', [
                getItem(
                    <Link to="/Facility/XAI/Dam_Heatmap">
                        <a style={{ textDecoration: "none", color:"black" }}>
                            {t.heatmap}
                        </a>
                    </Link>
                    , '17'),
                getItem(
                    <Link to="/Facility/XAI/Dam_Captioning">
                        <a style={{ textDecoration: "none", color:"black" }}>
                            {t.captioning}
                        </a>
                    </Link>
